    ...
    <FormStep title="Condicion del paciente">
        <div className={styles.labeledInput} >
            ...
            <div className="flex">
                ...
                />
                <span className="font-bold mt-2 ml-1">Kg</span>
            </div>
            <p className="italic text-base ml-4">* Para pesarlo en casa con balanza de piso: pesarse con el animal alzado, luego sin el y hacer la resta.<br /> 
                Por ejemplo: humano + animal = 70kg; humano = 60kg; Peso del animal ={">"} 70kg - 60kg = 10Kg
            </p>
        </div>
        <div className={styles.labeledInput} >
            <label htmlFor="otrosAnimales">Convive con otros animales? <span className={styles.aclaracion}>(especificar)</span></label>
            <textarea 
                id="otrosAnimales"
        ...
        <div className={styles.labeledInput} >
            <label htmlFor="dietaActual">
                ...
                <span className={styles.aclaracion}>(si es un ultraprocesado/balanceado indicar marca y tipo)</span>
            </label>
            <textarea
                id="dietaActual"
        ...
        <div className={styles.labeledInput} >
            <label htmlFor="actividad">Nivel de actividad {" "}
                <span className={styles.aclaracion}>(indicar si sale a pasear, cuanto tiempo y frecuencia, si juega en casa, etc)</span>
            </label>
            <textarea
                id="actividad"
        ...
        <div className={styles.labeledInput} >
            ...
            <p className={styles.aclaracion}>Tocale la zona de las costillas con la yema de los dedos e intenta contar las costillas
            ejerciendo una leve presion: deberias sentir una parte dura (el hueso) y una depresion mas blanda que corresponde al espacio
            intercostal compuesto por musculo. Que opcion describe mejor tu experiencia?</p>
            <select
                id="costillas"
                value={data.costillas}
                onChange={handleChange}
            >
