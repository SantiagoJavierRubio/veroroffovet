...
table, td { color: #231955; } #u_body a { color: #0000ee; text-decoration: underline; }
    </style>
...
<body class="clean-body u_body" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;background-color: #f6ece3;color: #231955">
  ...
  <table id="u_body" style="border-collapse: collapse;table-layout: fixed;border-spacing: 0;mso-table-lspace: 0pt;mso-table-rspace: 0pt;vertical-align: top;min-width: 320px;Margin: 0 auto;background-color: #f6ece3;width:100%" cellpadding="0" cellspacing="0">
  <tbody>
...
<div align="center">
  <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://localhost:3000/api/auth/signin" style="height:37px; v-text-anchor:middle; width:100px;" arcsize="11%"  stroke="f" fillcolor="#231955"><w:anchorlock/><center style="color:#FFFFFF;font-family: inherit; "><![endif]-->
    <a href="http://localhost:3000/api/auth/signin" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #231955; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-family: inherit; font-size: 14px;font-weight: 700; ">
